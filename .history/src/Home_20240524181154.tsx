import { StyleSheet, View, Text, SafeAreaView, TouchableOpacity, Image, TextInput, FlatList, Dimensions, ScrollView, Pressable, TouchableHighlightBase } from 'react-native'
...
const Product = ({ brand, name, price, image }: any) => (
  <View style={st.itemProduct}>
    ...
    <TouchableHighlightBase style={st.AddToCart}><Image source={require('./image/plusIcon.png')} style={st.plusIcon} /></TouchableHighlightBase>
  </View>
);
