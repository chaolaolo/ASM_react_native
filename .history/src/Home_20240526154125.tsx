...
const Home = ({ navigation }: any) => {
  return (
    <SafeAreaView style={st.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{backgroundColor:'red', flexGrow:1}}>
      ...
      <ScrollView style={st.boxProduct} horizontal={false} contentContainerStyle={{flexGrow:1}}>
