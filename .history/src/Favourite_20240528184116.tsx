...
const Favourite = () => {
    ...
    const Prod1 = [
        ...
        { id: '6', brand: 'Rolex', name: 'Watch 1', size: ['130mm', '145mm', '150mm', '160mm'], price: '100', image: require('./image/prod3.png'), rate: 4.1, address: 'Tp. Hue', rateCount: 43 },
        { id: '7', brand: 'Rolex', name: 'Watch 2', size: ['130mm', '145mm', '150mm', '160mm'], price: '100', image: require('./image/prod2.png'), rate: 3.5, address: 'Hai Phong', rateCount: 234 },
        { id: '8', brand: 'Rolex', name: 'Watch 3', size: ['130mm', '145mm', '150mm', '160mm'], price: '100', image: require('./image/prod1.png'), rate: 4.5, address: 'Ha Noi', rateCount: 5432 },
        { id: '9', brand: 'Rolex', name: 'Watch 4', size: ['130mm', '145mm', '150mm', '160mm'], price: '100', image: require('./image/prod3.png'), rate: 5, address: 'Ca Mau', rateCount: 142 },
