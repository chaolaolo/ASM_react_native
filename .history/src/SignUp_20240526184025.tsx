    ...
    return (
        ...
        // <SafeAreaView style={st.container}>
            <ScrollView contentContainerStyle={st.all}>
                ...
                <Text style={{fontSize:40}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate accusantium eos est incidunt odio dolorem exercitationem tempore minima eum aliquid sequi natus eveniet, nesciunt quasi iste qui placeat ullam ipsam.</Text>
            </ScrollView>
        // </SafeAreaView>
        // </KeyboardAvoidingView>
    )
