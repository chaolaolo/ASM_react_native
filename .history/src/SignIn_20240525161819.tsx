import { StyleSheet, View, Text, SafeAreaView, Image, TextInput, Button, ImageBackground, TouchableOpacity, Platform, Pressable } from 'react-native'
      ...
      <SafeAreaView style={st.all}>
        ...
        <View>
          <View style={st.t_left}>
            ...
            <Pressable style={st.t2} onPress={()=>{navigation.navigate('SignUp')}}>Sign Up</Pressable>
          </View>
          <View style={st.t_left}>
