import { StyleSheet, View, Text, SafeAreaView, TouchableOpacity, Image, TextInput, FlatList, Dimensions, ScrollView } from 'react-native'
...
const Homecopy = () => {
  return (
    <SafeAreaView style={st.container}>
      ...
      />
      <ScrollView style={st.boxProduct}>
