        ...
        // <SafeAreaView style={st.container}>
            <ScrollView contentContainerStyle={st.all}>
              <Image source={require('./image/logo.png')} style={st.logo} />
                ...
                <Text style={{fontSize:100}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate accusantium eos est incidunt odio dolorem exercitationem tempore minima eum aliquid sequi natus eveniet, nesciunt quasi iste qui placeat ullam ipsam.</Text>
            </ScrollView>
        // </SafeAreaView>
        // </KeyboardAvoidingView>
    )
