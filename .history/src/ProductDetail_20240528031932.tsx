                ...
                <View style={st.bottom}>
                    ...
                    <View>
                        ...
                        <View style={{ flexDirection: 'row', marginHorizontal: '4%' }}>
                            ...
                            <Text style={st.txtSize}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, consectetur aliquam perferendis commodi molestias quasi enim fugiat id nulla vel. Necessitatibus optio illo eius consectetur accusamus. Aperiam laudantium placeat tenetur!</Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
