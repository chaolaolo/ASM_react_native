import { StyleSheet, View, Text, SafeAreaView, TouchableOpacity, Image, TextInput, FlatList, Dimensions, ScrollView, Pressable, Touchable, ImageBackground } from 'react-native'
...
const Product = ({ brand, name, price, image }: any) => (
  <View style={st.itemProduct}>
    ...
    <ImageBackground source={image} style={st.imageProduct} />
