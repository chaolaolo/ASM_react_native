...
const Home = () => {
  ...
  const Prod1 = [
    { id: '1', brand: 'Rolex', name: 'item1 Chao lao lo Chao Lao Lo', price: '100', image: require('./image/prod1.png'), rate: 5 },
    { id: '2', brand: 'Rolex', name: 'item2', price: '100', image: require('./image/prod1.png'), rate: 5 },
    { id: '3', brand: 'Rolex', name: 'item3', price: '100', image: require('./image/prod1.png'), rate: 4 },
    { id: '4', brand: 'Rolex', name: 'item4', price: '100', image: require('./image/prod1.png'), rate: 4.2 },
    { id: '5', brand: 'Rolex', name: 'item5', price: '100', image: require('./image/prod1.png'), rate: 4.5 },
    { id: '6', brand: 'Rolex', name: 'item1', price: '100', image: require('./image/prod1.png'), rate: 4.1 },
    { id: '7', brand: 'Rolex', name: 'item2', price: '100', image: require('./image/prod1.png'), rate: 3.5 },
    { id: '8', brand: 'Rolex', name: 'item3', price: '100', image: require('./image/prod1.png'), rate: 4.5 },
    { id: '9', brand: 'Rolex', name: 'item4', price: '100', image: require('./image/prod1.png'), rate: 5 },
    { id: '10', brand: 'Rolex', name: 'item10', price: '100', image: require('./image/prod1.png'), rate: 5 },
  ];
  const Prod2 = [
    { id: '1', brand: 'Cartier', name: 'item1', price: '100', image: require('./image/prod2.png'), rate: 4.7 },
    { id: '2', brand: 'Cartier', name: 'item2', price: '100', image: require('./image/prod2.png'), rate: 4.5 },
    { id: '3', brand: 'Cartier', name: 'item3', price: '100', image: require('./image/prod2.png'), rate: 4.3 },
    { id: '4', brand: 'Cartier', name: 'item4', price: '100', image: require('./image/prod2.png'), rate: 4.5 },
    { id: '5', brand: 'Cartier', name: 'item5', price: '100', image: require('./image/prod2.png'), rate: 4.4 },
    { id: '6', brand: 'Cartier', name: 'item1', price: '100', image: require('./image/prod2.png'), rate: 4.5 },
    { id: '7', brand: 'Cartier', name: 'item2', price: '100', image: require('./image/prod2.png'), rate: 4.7 },
    { id: '8', brand: 'Cartier', name: 'item3', price: '100', image: require('./image/prod2.png'), rate: 4.5 },
    { id: '9', brand: 'Cartier', name: 'item4', price: '100', image: require('./image/prod2.png'), rate: 4.5 },
    { id: '10', brand: 'Cartier', name: 'item10', price: '100', image: require('./image/prod2.png'), rate: 4.6 },
  ];
