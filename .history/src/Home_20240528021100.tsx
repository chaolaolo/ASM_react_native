...
const Home = () => {
  ...
  const Prod1 = [
    { id: '1', brand: 'Rolex', name: 'item1 Chao lao lo Chao Lao Lo', price: '100', image: require('./image/prod1.png'), rate: 5, address: 'Ha Noi' },
    { id: '2', brand: 'Rolex', name: 'item2', price: '100', image: require('./image/prod1.png'), rate: 5, address: 'Ha Noi' },
    { id: '3', brand: 'Rolex', name: 'item3', price: '100', image: require('./image/prod1.png'), rate: 4, address: 'Ha Noi' },
    { id: '4', brand: 'Rolex', name: 'item4', price: '100', image: require('./image/prod1.png'), rate: 4.2, address: 'Ha Noi' },
    { id: '5', brand: 'Rolex', name: 'item5', price: '100', image: require('./image/prod1.png'), rate: 4.5, address: 'Ha Noi' },
    { id: '6', brand: 'Rolex', name: 'item1', price: '100', image: require('./image/prod1.png'), rate: 4.1, address: 'Ha Noi' },
    { id: '7', brand: 'Rolex', name: 'item2', price: '100', image: require('./image/prod1.png'), rate: 3.5, address: 'Ha Noi' },
    { id: '8', brand: 'Rolex', name: 'item3', price: '100', image: require('./image/prod1.png'), rate: 4.5, address: 'Ha Noi' },
    { id: '9', brand: 'Rolex', name: 'item4', price: '100', image: require('./image/prod1.png'), rate: 5, address: 'Ha Noi' },
