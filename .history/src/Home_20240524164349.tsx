...
const Prod1 = [
  ...
  // { id: '2', name: 'item2', image: require('./image/logo.png') },
  // { id: '3', name: 'item3', image: require('./image/logo.png') },
  // { id: '4', name: 'item4', image: require('./image/logo.png') },
  // { id: '5', name: 'item5', image: require('./image/logo.png') },
  // { id: '6', name: 'item1', image: require('./image/logo.png') },
  // { id: '7', name: 'item2', image: require('./image/logo.png') },
  // { id: '8', name: 'item3', image: require('./image/logo.png') },
  // { id: '9', name: 'item4', image: require('./image/logo.png') },
  // { id: '10', name: 'item5', image: require('./image/logo.png') },
];
...
// const Product = ({ name, image}: any) => (
//   <View style={st.itemCategory}>
//     <Image source={image} style={st.imageCategory} />
//     <Text style={st.titleCategory}>{name}</Text>
//   </View>
// );
// const renderProd = ({ item }: any) => <Product title={item.name} image={item.image} />;
