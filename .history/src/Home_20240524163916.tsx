...
const Prod1 = [
  { id: '1', title: 'item1', image: require('./image/logo.png') },
  { id: '2', title: 'item2', image: require('./image/logo.png') },
  { id: '3', title: 'item3', image: require('./image/logo.png') },
  { id: '4', title: 'item4', image: require('./image/logo.png') },
  { id: '5', title: 'item5', image: require('./image/logo.png') },
  { id: '6', title: 'item1', image: require('./image/logo.png') },
  { id: '7', title: 'item2', image: require('./image/logo.png') },
  { id: '8', title: 'item3', image: require('./image/logo.png') },
  { id: '9', title: 'item4', image: require('./image/logo.png') },
  { id: '10', title: 'item5', image: require('./image/logo.png') },
];
...
const Product = ({ item}: any) => (
  <View style={st.itemCategory}>
    <Image source={item.image} style={st.imageCategory} />
    <Text style={st.titleCategory}>{item.title}</Text>
  </View>
);
const renderProd = ({ item }: any) => <Product title={item.title} image={item.image} />;
